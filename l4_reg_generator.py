...
def generate_field_cpp(l2_df, output_dir):
    ...
    with open(output_file, 'w') as f:
        # Write header
        f.write("// Auto-generated field definitions from ARM CMN register extraction\n")
        f.write("// Generated by L4 C++ Generator\n")
        f.write("\n")
        f.write('#include "vlab/Field.h"\n')
        f.write("\n")
        f.write("// Field definitions\n")
        f.write("// Format: vlab::Field64 <REGISTER_NAME>_<FIELD_NAME> {\"<field_name>\", <start_bit>, <bit_size>[, access][, write_effect]};\n")
        f.write("\n")
...
def generate_register_cpp(l3_data, l2_df, field_variables, output_dir):
    ...
    with open(output_file, 'w') as f:
        # Write header
        f.write("// Auto-generated register definitions from ARM CMN register extraction\n")
        f.write("// Generated by L4 C++ Generator\n")
        f.write("// Follows register_data.json order exactly\n")
        f.write("\n")
        f.write('#include "field.h"\n')
        f.write("\n")
